...
abstract class FullSchemaParserTestCase extends TestCase
{
    abstract protected static function fixturesSubDirectory(): string;
    ...
    public static function getSchemaProvider(): array
    {
        $directoryIterator = new RecursiveIteratorIterator(
            new \RecursiveDirectoryIterator(FIXTURES_DIRECTORY . static::fixturesSubDirectory())
        );
    ...
    public function testParser(
        ...
        $sut = $this->createParser();
        $result = $sut->run(file_get_contents($file->getRealPath()), $forcedConnections);
